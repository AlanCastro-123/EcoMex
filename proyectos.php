...
<body>
    ...
    <div class="container">
        ...
        <head>
            <h1 style="text-align: center; margin: 50px;">Proyectos</h1>
        </head>
        <nav>
            <a href='agregar.php'><button type='button' class='btn btn-success float-right' style='width: auto;'>Nueva Publicación</button></a>
        </nav>
