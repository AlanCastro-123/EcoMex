...
<html lang="en">
  ...
  <body>
    ...
    <?php
      if ($_SESSION['rol'] == 0)
      {
        echo '<button type="button" class="btn btn-success">Nuevo</button><br>';
      }
    ?>
      <br>
        <?php 
          ...
          while($fila = mysqli_fetch_array($query)){
            ...
            echo '<img src="data:image/jpg;charset=utf8;base64,'.($fila['img']).'" alt="Imagen noticia" class="img-circular"/>';
            ...
            if ($_SESSION['rol'] == 0){
              ...
              echo '<button type="button" class="btn btn-danger" data-toggle="modal" data-target="#confirm-delete">Borrar</button>';
              echo '</div>';
            }
            echo '</div>';
            echo '<hr>';
